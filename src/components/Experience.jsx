    ...
    <div className="h-full gap-2 flex-col full w-full flex">
      ...
      <div className="flex lg:flex-row md:flex-row flex-col">
        <div className="flex gap-2 justify-center">
          <div className="w-32 md:w-25 lg:w-55 flex flex-col gap-2">
            <img src="postgradDrinks.jpg" className="h-18 w-35 md:h-15 md:w-25 lg:h-30 lg:w-55 object-cover boo" alt="Postgraduate Drinks with Academics - Panel"></img>
            <p className="text-[0.5rem] md:text-[0.4rem] lg:text-[0.6rem] text-center">Postgraduate Drinks with Academics - Panel</p>
          </div>

          <div className="w-32 md:w-25 lg:w-55 flex flex-col gap-2">
          <img src="iwd.JPG" className="h-18 w-35 md:h-15 md:w-25 lg:h-30 lg:w-55 object-cover boo" alt="International Women's Day - Hosting Atlassian, IMC, Quantium, Trade Desk, Domain, etc."></img>
